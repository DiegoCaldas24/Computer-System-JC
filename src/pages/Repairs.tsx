...
export function RepairsPage() {
  return (
    <div className="pt-0 pb-24 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-20 items-center mb-32">
          <div>
            ...
            <button className="bg-green-500 hover:bg-green-600 text-white px-10 py-5 rounded-4xl font-bold text-lg flex items-center justify-center gap-3 shadow-xl transition-all hover:scale-105">
